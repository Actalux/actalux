...
Usage:
  doppler run --project actalux --config dev -- uv run python scripts/fix_portal_renames.py
  doppler run --project actalux --config dev -- uv run python scripts/fix_portal_renames.py --apply
"""
